...
local function drawScreen()
    ...
    drawScreenTitle("Emuflight / "..screen_title)
...
function run_ui(event)
    ...
    elseif currentState == pageStatus.saving then
        ...
        if saveRetries <= 0 then
            ...
            lcd.drawText(SaveBox.x+SaveBox.x_offset,SaveBox.y+SaveBox.h_offset,"GG Beau Gosse",SMLSIZE + BLINK + (globalTextOptions))
        end
    end
